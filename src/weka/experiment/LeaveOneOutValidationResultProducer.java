...
/*
 *    LeaveOneOutValidationResultProducer.java
 ...
 */
public class LeaveOneOutValidationResultProducer implements ResultProducer,
  ...
  public void setAdditionalMeasures(String[] additionalMeasures) {
    ...
    if (m_SplitEvaluator != null) {
      System.err.println("LeaveOneOutValidationResultProducer: setting additional "
  ...
  public double getMeasure(String additionalMeasureName) {
    if (m_SplitEvaluator instanceof AdditionalMeasureProducer) {
      ...
      throw new IllegalArgumentException("LeaveOneOutValidationResultProducer: "
  ...
  public void doRunKeys(int run) throws Exception {
    ...
    m_NumFolds = m_Instances.numInstances(); //Gualberto Asencio Cortes, PhD (Aug, 2018)
  ...
  public String toString() {
    ...
    String result = "LeaveOneOutValidationResultProducer: ";
...
} // LeaveOneOutValidationResultProducer

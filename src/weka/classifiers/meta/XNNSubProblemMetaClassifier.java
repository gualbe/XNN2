...
public class XNNSubProblemMetaClassifier extends RandomizableMultipleClassifiersCombiner implements UpdateableClassifier {
    ...
    public XNNSubProblemMetaClassifier() {
        super();
    ...
    public XNNSubProblemMetaClassifier(Clusterer subProblemMaker, Classifier subProblemSelector) {
